...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: tabList.length, initialIndex: 0, vsync: this);
  }
...
GFListTile(
  ...
  hoverColor: Colors.green, // Color when a pointer is hovering over the tile
  focusNode: FocusNode(), // Define a focus node for the tile
  autofocus: true, // Set to true if the tile should automatically focus itself
